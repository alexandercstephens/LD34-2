            ...
            float4 frag(VertexOutput input) : COLOR
            {
	            ...
	            else
	            {
	            	...
	            	if (1.0 != _LightMatrix0[3][3]) //If this is a spotlight, calculate cookie attenuation.
		            {
		            	...
		            	//This is my dumb little implementation - it produces a hard-edged circle (or ellipse) of
		            	//illumination from the spotlight. Eventually it ought to have a cookie texture applied to it,
		            	//but so far I haven't figured out how to do that yet. If you want smoother edges, you could play
		            	//with fading the value of 'cookieAttenuation' to zero as 'distanceFromCamera' approaches 1.0.
		            	//Anyway, it's a start.
		            	if (distanceFromCentre > 1.0)
		            	{
		            		cookieAttenuation *= 0.0;
		            	}
		            }
